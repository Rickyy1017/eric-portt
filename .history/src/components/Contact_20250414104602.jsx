          ...
          <div className="flex flex-col lg:w-1/2 w-full gap-5">
            ...
            <div data-aos="fade-up-left" data-aos-duration="1000" className="flex items-start flex-col gap-2">
              ...
              <div className="flex items-center gap-5">
                ...
                <Link lassName='text-xl text-zinc-300' to="https://wa.me/+2348134972329?text=Hi%20I%20would%20love%20to%20connect!" https://wa.link/xbn55o target="_blank"> <BsWhatsapp /></Link>
