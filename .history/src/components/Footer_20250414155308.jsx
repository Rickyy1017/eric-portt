...
const Footer = () => {
  const apps = [
    {
      img:<BsTwitterX/>,
      link:'https://x.com/Flacko_eth'
    },
  
    {
      img:<FaGithub/>,
      link:'https://github.com/Rickyy1017'
    },
      {
      img:<CiMail/>,
      link:"mailto:ericjoseph6303@gmail.com?subject=Hello&body=I%20would%20like%20to%20connect%20with%20you."
    },
  ]
    ...
    <div className='bg-sec pb-24  h-52 text-white w-full'>
      ...
      className="w-11/12 mt-3  mx-auto gap-10  flex flex-col lg:flex-row  justify-between">
        <div className="flex items-center gap-4">
          <div className="font-bold text-xl">eR!k</div>
