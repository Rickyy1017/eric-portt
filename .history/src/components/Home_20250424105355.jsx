...
export const localName = 'Repositories'
...
const Home = () => {
    ...
    const storedRepos = JSON.parse(localStorage.getItem(localName)) || []
    return (
        <div className=' w-full relative  ' >
            ...
            <div className=" w-11/12 mx-auto px-2 pt-24 ">
                ...
                <Hero num={num} repo={storedRepos.length} loading={loading} />
            </div>
            ...
            <div className="lg:mt-10 w-full flex-col flex items-center justify-center py-10">
                ...
                <Link to={`/projects`} className="text-primary underline"></Link>
            </div>
