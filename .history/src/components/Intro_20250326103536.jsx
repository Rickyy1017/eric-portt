            ...
            <div className="w-11/12  mx-auto flex  lg:h-[27rem] flex-col lg:flex-row  items-start gap-10">
                ...
                <div className="w-full lg:w-1/2 flex py-2 gap-10 items-start justify-between h-full flex-col">
                    ...
                    <div className="flex items-start gap-3 flex-col">
                        ...
                        <div data-aos-duration="1000" data-aos="fade-down" className="font-bold tracking-wide text-[1rem]">Whether developing efficient APIs, crafting seamless UIs, or developing smar server performance, I bring a detail-oriented approach to every project. Let's build innovative solutions together!</div>
                    </div>
