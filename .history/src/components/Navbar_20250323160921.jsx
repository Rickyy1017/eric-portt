                            ...
                            <div className="flex  gap-20 items-center justify-center flex-col py-5   h-full">
                                ...
                                <div className="flex flex-col gap-5">
                                    ...
                                    <div className="flex flex-col gap-3">
                                        {navs.map((item, i) => {
                                            return (
                                                <Link key={i} onClick={() => setModal(false)} to={item.url} className={`${location.pathname === item.url && 'bg-primary'} flex items-center   py-1.5 px-3 text-2xl cursor-pointer hover:bg-primary`}>{item.ame}</Link>
                                            )
                                        })}
                                    </div>
                                </div>
