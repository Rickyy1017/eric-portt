...
const Techs = () => {
    const techs = [
        {
            name: 'Frontend',
            others: ['ReactJs', "TypeScript",  'TailwindCSS', 'AOS', 'Framer Motion']
        },
        {
            name: 'Blockchain',
            others: ['Solidity', 'Foundry', "Ethers.js", ]
        },
        {
            name: 'Git',
     ...
     
        {
            ...
            others: [ 'Netlify', 'Vercel', "Anvil", 'GitHub Actions', "Ganache", "Sepolia Testnet" ]
        },
        {
            name: 'Other Tools',
            others: ['Visual Studio Code', 'Remix', 'Figma', "Trae"]
        },
        {
            name: 'Languages',
