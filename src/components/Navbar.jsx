                        ...
                        <div
                            ...
                            <div className="flex  gap-20 items-center justify-center flex-col py-5   h-full">
                                <div className="flex flex-col gap-5">
                                    ...
                                    <Link target='blank' to={`https://x.com/Flacko_eth`} className=" cursor-pointer flex px-5 items-center  gap-3">
                                        <div className="text-2xl">Twitter</div>
                                        <BsTwitterX className='text-2xl' />
                                    </Link>
                                    <Link target='blank' to={`https://github.com/Rickyy1017`} className="flex cursor-pointer px-5 items-center gap-3">
                                        <div className="text-2xl">Github</div>
                                        <FaGithub className='text-2xl' />
                                    </Link>
                                     <a href="mailto:ericjo6303@gmail.com?subject=Hello&body=I%20would%20like%20to%20connect%20with%20you."
