            ...
            <div className="w-10/12 mx-auto relative">
                ...
                <div data-aos="flip-down" data-aos-duration="1000" className=" mt-16  bg-sec lg:h-60 rounded-md p-2 relative">
                    ...
                    <div className="mt-10 px-10 flex flex-col gap-4">
                        ...
                        <div className="">There will always be doubters and haters but they only get the power you give them, remain focused and never loose faith in yourself - Morgan Freeman</div>
                        <div className="">Death is not the greatest loss in life. The greatest loss is what dies inside while still alive. Never surrender. – 2pac Shakur</div>
